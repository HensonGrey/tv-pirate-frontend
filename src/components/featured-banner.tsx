...
export default function FeaturedBanner({ item, onDetails }: FeaturedBannerProps) {
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            item.backdropUrl != null
              ? 'linear-gradient(to top, rgb(0 0 0 / 0.78), rgb(0 0 0 / 0.15) 45%, rgb(0 0 0 / 0.3))'
              : 'linear-gradient(to top, rgb(0 0 0 / 0.78), rgb(0 0 0 / 0.15) 45%, rgb(0 0 0 / 0.3)), linear-gradient(115deg, oklch(0.27 0.04 265), oklch(0.20 0.04 300))',
        }}
      >
