  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/80 backdrop-blur-md">
      ...
      >
        ...
        {/* Desktop tabs */}
        <nav aria-label="Sections" className="ml-2 hidden items-center gap-1 md:flex lg:ml-6">
      ...
      {/* Mobile tab strip */}
      <nav aria-label="Sections" className="no-scrollbar flex gap-1 overflow-x-auto px-4 pb-2 md:hidden">
        {TABS.map(({ id, label, icon: Icon }) => (
          <button
            key={id}
            type="button"
