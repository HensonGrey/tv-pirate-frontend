...
export default function WatchPage({ mediaType, user, onLogout }: WatchPageProps) {
              ...
              {activeSource ? (
                <MediaPlayer
                  ...
                  src={{
                    ...
                    type: activeSource.format === 'hls' ? 'application/x-mpegurl' : 'video/mp4',
                  }}
                  crossOrigin
                  playsInline
                ...
                <div className="flex size-full flex-col items-center justify-center gap-3 text-muted-foreground">
                  ...
                  {resolving ? (
                    <LoaderCircle aria-hidden className="relative size-12 animate-spin text-gold" />
                  ) : (
  ...
  return (
    <div className="relative min-h-dvh">
      ...
      {playerThumb && (
        <div aria-hidden className="absolute inset-x-0 top-0 h-[calc(100dvh-60px)] overflow-hidden">
          <img
            src={playerThumb}
            alt=""
